...
export function FooterHeader() {
  return (
    <div className="w-full flex flex-col gap-5 sm:gap-6 mb-3 sm:mb-4">
      ...
      {/* Second Row: [Let's talk tech + Social Buttons below] on left, [Contact Us] on right */}
      <div className="w-full flex flex-col md:flex-row md:items-start justify-between gap-6 sm:gap-8 pt-1">
        {/* Left Column: Let's talk tech + Social Buttons below it */}
        <div className="flex flex-col items-start gap-4 sm:gap-5">
          ...
          {/* Social Buttons moved down below Let's talk tech */}
          <motion.div
          ...
          >
            ...
            <a
              ...
              aria-label="Medium"
              className="w-9 h-9 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-full bg-white/5 hover:bg-white/15 flex items-center justify-center text-white/80 hover:text-white transition-all hover:scale-110"
            >
