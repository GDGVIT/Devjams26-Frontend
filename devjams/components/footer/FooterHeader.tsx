...
function SocialButtons({ className = "" }: { className?: string }) {
  return (
    <motion.div
      ...
      className={`items-center gap-3 sm:gap-4 ${className}`}
    >
      {/* Medium */}
      <a
        ...
        aria-label="Medium"
        className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-full bg-white/5 hover:bg-white/15 flex items-center justify-center text-white/80 hover:text-white transition-all hover:scale-110"
      >
...
export function FooterHeader() {
  return (
    <div className="w-full flex flex-col gap-4 sm:gap-6 md:gap-7 mb-2 sm:mb-3">
      {/* Top Row: Headline */}
      <div className="w-full flex flex-col md:flex-row md:items-start justify-between">
        <motion.h2
          ...
          className="font-normal font-[400] text-white tracking-tight leading-[0.98] text-[52px] sm:text-[73px] md:text-[clamp(6rem,7vw,7.2rem)]"
        >
      ...
      <div className="w-full flex flex-col md:flex-row md:items-start justify-between gap-5 sm:gap-8 pt-1">
        ...
        <div className="flex flex-col items-start gap-3 sm:gap-4">
          <motion.a
            ...
            className="text-white hover:text-white flex items-center gap-3 group transition-colors cursor-pointer leading-tight self-start text-[32px] sm:text-[42px] md:text-[clamp(2.5rem,3.5vw,52px)] font-[400]"
          >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5, delay: 0.2 }}
          className="flex flex-col items-start md:items-end text-left md:text-right gap-2.5 sm:gap-3.5"
        >
          {/* Contact us heading */}
          <h3 className="font-[400] text-white tracking-tight leading-tight text-[30px] sm:text-[36px] md:text-[clamp(1.9rem,2.8vw,42px)]">
            Contact us
          </h3>
          ...
          <div className="flex flex-col sm:flex-row gap-5 sm:gap-8 md:gap-10 text-gray-300">
            ...
            <div className="flex flex-col items-start md:items-end text-left md:text-right gap-1">
              <span
                ...
                style={{ fontSize: "clamp(1.18rem, 1.6vw, 24px)" }}
              >
              ...
              <a
                ...
                style={{ fontSize: "clamp(0.98rem, 1.25vw, 18px)" }}
              >
                +919686352426
              </a>
              <a
          ...
          <SocialButtons className="flex md:hidden mt-1.5 sm:mt-2.5" />
        </motion.div>
      </div>
    </div>
  );
