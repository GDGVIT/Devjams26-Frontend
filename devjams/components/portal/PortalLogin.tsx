    ...
    <main className="relative min-h-screen w-full bg-black text-white flex flex-col items-center justify-center overflow-hidden px-4 py-8 select-none">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center w-full max-w-5xl mx-auto">
        ...
        <motion.h1
          ...
          className="text-white text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-2 sm:mb-4 text-center z-30"
          style={{
        ...
        <motion.div
          ...
          className="relative z-30 mt-6 sm:mt-10 md:mt-12 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 w-full px-4 max-w-4xl"
        >
          ...
          <Link href="/portal/onboarding" className="w-full sm:w-auto inline-block">
            <motion.div
              ...
              whileTap={{ scale: 0.96 }}
              className="group w-full sm:w-auto min-w-[280px] sm:min-w-[330px] md:min-w-[350px] h-[54px] px-6 sm:px-8 rounded-full bg-[#2A2A2E]/90 hover:bg-white text-white hover:text-black border border-white/10 hover:border-transparent font-bold text-sm sm:text-base flex items-center justify-center gap-2.5 sm:gap-3 transition-colors duration-200 shadow-[0_4px_20px_rgba(0,0,0,0.5)] cursor-pointer select-none"
              style={{
                fontFamily: '"Google Sans", var(--font-google-sans), sans-serif',
              }}
            >
          ...
          {/* "or" separator */}
          <span className="text-white/60 text-sm font-normal px-1 select-none">
            or
          </span>
