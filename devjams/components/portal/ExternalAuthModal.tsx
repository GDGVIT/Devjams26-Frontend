      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-[#2A2A2E]/90 hover:bg-white text-white hover:text-black border border-white/10 hover:border-transparent font-normal text-xs transition-colors duration-200 shadow-[0_4px_15px_rgba(0,0,0,0.3)] disabled:opacity-50 cursor-pointer"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          <div>
            <label className="block text-xs font-normal text-neutral-300 mb-1">
              Full Name
            </label>
            <input
              type="text"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-3 py-3 px-4 rounded-full bg-[#2A2A2E]/90 hover:bg-white text-white hover:text-black border border-white/10 hover:border-transparent font-normal text-sm transition-colors duration-200 shadow-[0_4px_20px_rgba(0,0,0,0.5)] disabled:opacity-50 cursor-pointer"
          >
