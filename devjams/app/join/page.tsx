...
export default function JoinPage() {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      // Fit within viewport cleanly on any desktop screen height/width with no scroll
  ...
  return (
    <main className="fixed inset-0 h-screen w-screen bg-black text-white flex items-center justify-center overflow-hidden select-none">
      ...
      >
        ...
        {/* Right Side 3 Logos Stack (Landing Frame 2 Logos with Glowing Blend) */}
        <div
        ...
        >
          ...
          {/* Maps Logo with Screen Blend Mode */}
          <div
            className="absolute"
            style={{
              width: "364.11px",
          ...
          {/* Android Track Logo with Screen Blend Mode */}
          <div
            className="absolute"
            style={{
              width: "467.63px",
